...
namespace fell::storage {
   ...
   * By keeping this component passive and single-threaded, concurrency controls and batching
   * decisions are elevated to the PartitionStore layer.
   *
   * Assumptions:
